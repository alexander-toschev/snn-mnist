...
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_T100_N5000_2layer_greedy_gn1_1500_localinhib_s085_rate007_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) T=100 N=5000 greedy_n1=1500 local_inhib=0.85 rate_scale=0.007 started at $(date -Is)" | tee -a "$LOG"
...
python agent_mvp/experiment_runner.py \
  ...
  --set greedy_enable=true --set greedy_n1=1500 \

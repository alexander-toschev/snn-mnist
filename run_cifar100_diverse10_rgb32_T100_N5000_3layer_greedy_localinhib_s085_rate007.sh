...
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_T100_N5000_3layer_greedy_localinhib_s085_rate007_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) T=100 N=5000 3layer greedy + local_inhib(s=0.85) rate_scale=0.007 started at $(date -Is)" | tee -a "$LOG"

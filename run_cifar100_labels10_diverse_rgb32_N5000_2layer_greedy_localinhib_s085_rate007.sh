...
# 0 apple, 1 aquarium_fish, 2 baby, 3 bear, 5 bed, 8 bicycle, 13 bus, 14 butterfly, 17 castle, 19 cattle
DATASET="cifar100:0,1,2,3,5,8,13,14,17,19"

OUTDIR="runs_csnn"
STAMP=$(date -u +%Y%m%dT%H%M%SZ)
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_N5000_2layer_greedy_localinhib_s085_rate007_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) N=5000 2layer greedy + local_inhib(s=0.85) rate_scale=0.007 started at $(date -Is)" | tee -a "$LOG"

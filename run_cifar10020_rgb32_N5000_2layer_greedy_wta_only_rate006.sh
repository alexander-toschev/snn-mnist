...
LOG="$OUTDIR/cifar10020_rgb32_N5000_2layer_greedy_wta_only_rate006_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run CIFAR100:20 RGB32 N=5000 2layer greedy+WTA ONLY (no EI, no homeo) rate_scale=0.006 started at $(date -Is)" | tee -a "$LOG"

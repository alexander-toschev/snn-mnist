...
LOG="$OUTDIR/stabilize_cifar10020_rgb32_N2000_2layer_greedy_wta_ei_homeo_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run STABILIZE CIFAR100:20 RGB32 N=2000 2layer greedy+WTA+EI+HOMEOSTASIS started at $(date -Is)" | tee -a "$LOG"
...
python agent_mvp/experiment_runner.py \
  ...
  --set greedy_enable=true --set greedy_n1=1000 \
  ...
  --set homeo_spikes_lo=20000 --set homeo_spikes_hi=30000 --set homeo_spikes_target=25000 \

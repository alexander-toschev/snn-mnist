...
LOG="$OUTDIR/stabilize_cifar10020_rgb32_N5000_2layer_greedy_wta_ei_homeo_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run STABILIZE CIFAR100:20 RGB32 N=5000 2layer greedy+WTA+EI+HOMEOSTASIS started at $(date -Is)" | tee -a "$LOG"

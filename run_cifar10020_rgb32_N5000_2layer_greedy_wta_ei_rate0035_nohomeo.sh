...
LOG="$OUTDIR/cifar10020_rgb32_N5000_2layer_greedy_wta_ei_rate0035_nohomeo_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run CIFAR100:20 RGB32 N=5000 2layer greedy+WTA+EI (NO homeo) rate_scale=0.0035 started at $(date -Is)" | tee -a "$LOG"

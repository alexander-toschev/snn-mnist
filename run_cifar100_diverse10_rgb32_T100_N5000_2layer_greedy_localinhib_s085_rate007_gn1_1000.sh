...
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_T100_N5000_2layer_greedy_gn1_1000_localinhib_s085_rate007_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) T=100 N=5000 greedy_n1=1000 local_inhib=0.85 rate_scale=0.007 started at $(date -Is)" | tee -a "$LOG"

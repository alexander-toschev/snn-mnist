...
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_T100_N5000_3layerWIDE_greedy_localinhib_s085_rate007_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) T=100 N=5000 3layerWIDE greedy + local_inhib(s=0.85) rate_scale=0.007 started at $(date -Is)" | tee -a "$LOG"
...
python agent_mvp/experiment_runner.py \
  ...
  --set c3_out=256 --set c3_kernel=3 --set c3_pad=1 --set c3_stride=2 \

...
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_T200_N5000_2layer_greedy_gn1_5000_localinhib_s085_rate0035_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) 2-layer T=200 N=5000 greedy_n1=5000 local_inhib=0.85 rate_scale=0.0035 started at $(date -Is)" | tee -a "$LOG"

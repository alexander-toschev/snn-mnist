...
LOG="$OUTDIR/sweep_rate_scale_homeo_fashion_N5000_${STAMP}.log"
SUMMARY_JSONL="$OUTDIR/sweep_rate_scale_homeo_fashion_N5000_${STAMP}.summary.jsonl"

mkdir -p "$OUTDIR"

echo "Sweep rate_scale (homeo fixed) started at $(date -Is)" | tee -a "$LOG"
...
# Sweep poisson_rate_scale
run_one "rate_scale_0.004" --set poisson_rate_scale=0.004
run_one "rate_scale_0.005" --set poisson_rate_scale=0.005
run_one "rate_scale_0.006" --set poisson_rate_scale=0.006
run_one "rate_scale_0.007" --set poisson_rate_scale=0.007
run_one "rate_scale_0.008" --set poisson_rate_scale=0.008

...
LOG="$OUTDIR/${DATASET//[: ,]/_}_rgb32_T200_N5000_2layer_greedy_localinhib_s085_rate007_${STAMP}.log"
mkdir -p "$OUTDIR"

echo "Run ${DATASET} RGB32 (diverse10) T=200 N=5000 2layer greedy + local_inhib(s=0.85) rate_scale=0.007 started at $(date -Is)" | tee -a "$LOG"
